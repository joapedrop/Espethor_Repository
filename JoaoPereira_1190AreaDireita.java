public class JoaoPereira_1190AreaDireita {
    ...
    public static double imprimirMediaAreaEsquerda(double[][] M, double media) {
        double soma = 0;
    ...
    public static void main(String[] args) {
        ...
        switch (tipo) {
            case 'S':
                soma = imprimirSomaAreaEsquerda(matriz, soma);
                System.out.printf("%.1f\n", soma);

                break;

            case 'M':
                media = imprimirMediaAreaEsquerda(matriz, media);
                System.out.printf("%.1f\n", media);
                break;
